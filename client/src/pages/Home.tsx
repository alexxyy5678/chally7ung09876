...
import { Wallet, TrendingUp, Trophy, Moon, Sun } from "lucide-react";
        ...
        <div className="flex justify-between items-center max-w-md mx-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button 
              variant="outline" 
              size="sm"
              className="rounded-full border-secondary/30 bg-secondary/10 text-secondary hover:bg-secondary/20 hover:border-secondary/50 transition-colors"
            >
